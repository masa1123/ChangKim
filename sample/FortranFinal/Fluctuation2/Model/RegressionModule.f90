...
subroutine RegressLOM()
	...
	!	law of motion for the second moment of asset distribution

	call d_rlse(dlog(K2data(Nskip+2:Nperiod+1)), RHS, NewK2coef, sst=sst, sse=sse)
...
subroutine FinalRegressLOM()
	...
	call dr2se(nobs, dlog(Kdata(Nskip+2:Nperiod+1)), 3, RHS, nobs, 1, NewKcoef, sst, sse, R, 4, dfe, nrmiss, WK)
	call d_rstat(irbef, NewKcoef, R, dfe, sse, AOV, SQSS, COEF, COVB, ief = -3, print='A')
	...
	!	second moment of the asset distribution

	call dr2se(nobs, dlog(K2data(Nskip+2:Nperiod+1)), 3, RHS, nobs, 1, NewK2coef, sst, sse, R, 4, dfe, nrmiss, WK)
	call d_rstat(irbef, NewK2coef, R, dfe, sse, AOV, SQSS, COEF, COVB, ief = -3, print='A')
	...
	call dr2se(nobs, dlog(Rdata(Nskip+1:Nperiod)), 3, RHS, nobs, 1, NewRcoef, sst, sse, R, 4, dfe, nrmiss, WK)
	call d_rstat(irbef, NewRcoef, R, dfe, sse, AOV, SQSS, COEF, COVB, ief = -3, print='A')
	...
	call dr2se(nobs, dlog(Wdata(Nskip+1:Nperiod)), 3, RHS, nobs, 1, NewWcoef, sst, sse, R, 4, dfe, nrmiss, WK)
	call d_rstat(irbef, NewWcoef, R, dfe, sse, AOV, SQSS, COEF, COVB, ief = -3, print='A')
